...
export class ExperienceInformationComponent implements OnInit {
    ...
    displayedColumns: string[] = ['id', 'company_name', 'department', 'position', 'action'];
    ...
    constructor(
        ...
        this.route = 'user-settings/experience';
    ...
    ngOnInit() {
        this.experience_data = this.data;

        this.dataSource = new MatTableDataSource(this.experience_data);
