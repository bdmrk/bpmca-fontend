...
@Component({
  selector: 'app-podcast-comment',
  templateUrl: './podcast-comment.component.html',
  styleUrls: ['./podcast-comment.component.scss']
})
export class PodcastCommentComponent implements OnInit {
