...
@Component({
  selector: 'app-course-filter-section',
  templateUrl: './course-filter-section.component.html',
  styleUrls: ['./course-filter-section.component.scss']
})
export class CourseFilterSectionComponent implements OnInit {
